...
impl_float_to_int!(f16 => u8, u16, u24, u32, u64, u128, usize, i8, i16, i24, i32, i64, i128, isize);
impl_float_to_int!(f32 => u8, u16, u24, u32, u64, u128, usize, i8, i16, i24, i32, i64, i128, isize);
impl_float_to_int!(f64 => u8, u16, u24, u32, u64, u128, usize, i8, i16, i24, i32, i64, i128, isize);
impl_float_to_int!(f128 => u8, u16, u24, u32, u64, u128, usize, i8, i16, i24, i32, i64, i128, isize);
...
impl_from!(u8 => u24, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(u8 => u32, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(u8 => u64, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(u8 => u128, #[stable(feature = "i128", since = "1.26.0")]);
impl_from!(u8 => usize, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(u16 => u24, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(u16 => u32, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(u16 => u64, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(u16 => u128, #[stable(feature = "i128", since = "1.26.0")]);
impl_from!(u24 => u32, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(u24 => u64, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(u24 => u128, #[stable(feature = "i128", since = "1.26.0")]);
...
impl_from!(i8 => i24, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(i8 => i32, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(i8 => i64, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(i8 => i128, #[stable(feature = "i128", since = "1.26.0")]);
impl_from!(i8 => isize, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(i16 => i24, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(i16 => i32, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(i16 => i64, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(i16 => i128, #[stable(feature = "i128", since = "1.26.0")]);
impl_from!(i24 => i32, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(i24 => i64, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(i24 => i128, #[stable(feature = "i128", since = "1.26.0")]);
...
impl_from!(u8 => i24, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(u8 => i32, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(u8 => i64, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(u8 => i128, #[stable(feature = "i128", since = "1.26.0")]);
impl_from!(u16 => i24, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(u16 => i32, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(u16 => i64, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(u16 => i128, #[stable(feature = "i128", since = "1.26.0")]);
impl_from!(u24 => i32, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(u24 => i64, #[stable(feature = "lossless_int_conv", since = "1.5.0")]);
impl_from!(u24 => i128, #[stable(feature = "i128", since = "1.26.0")]);
...
impl_try_from_upper_bounded!(u24 => u8, u16);
impl_try_from_upper_bounded!(u32 => u8, u16, u24);
impl_try_from_upper_bounded!(u64 => u8, u16, u24, u32);
impl_try_from_upper_bounded!(u128 => u8, u16, u24, u32, u64);

// signed integer -> signed integer
impl_try_from_both_bounded!(i16 => i8);
impl_try_from_both_bounded!(i24 => i8, i16);
impl_try_from_both_bounded!(i32 => i8, i16, i24);
impl_try_from_both_bounded!(i64 => i8, i16, i24, i32);
impl_try_from_both_bounded!(i128 => i8, i16, i24, i32, i64);

// unsigned integer -> signed integer
impl_try_from_upper_bounded!(u8 => i8);
impl_try_from_upper_bounded!(u16 => i8, i16);
impl_try_from_upper_bounded!(u24 => i8, i16, i24);
impl_try_from_upper_bounded!(u32 => i8, i16, i24, i32);
impl_try_from_upper_bounded!(u64 => i8, i16, i24, i32, i64);
impl_try_from_upper_bounded!(u128 => i8, i16, i24, i32, i64, i128);

// signed integer -> unsigned integer
impl_try_from_lower_bounded!(i8 => u8, u16, u24, u32, u64, u128);
impl_try_from_both_bounded!(i16 => u8);
impl_try_from_lower_bounded!(i16 => u16, u24, u32, u64, u128);
impl_try_from_both_bounded!(i24 => u8, u16);
impl_try_from_lower_bounded!(i24 => u24, u32, u64, u128);
impl_try_from_both_bounded!(i32 => u8, u16, u24);
impl_try_from_lower_bounded!(i32 => u32, u64, u128);
impl_try_from_both_bounded!(i64 => u8, u16, u24, u32);
impl_try_from_lower_bounded!(i64 => u64, u128);
impl_try_from_both_bounded!(i128 => u8, u16, u24, u32, u64);
...
mod ptr_try_from_impls {
    ...
    impl_try_from_unbounded!(usize => u16, u24, u32, u64, u128);
    impl_try_from_upper_bounded!(usize => i8, i16);
    impl_try_from_unbounded!(usize => i24, i32, i64, i128);

    impl_try_from_both_bounded!(isize => u8);
    impl_try_from_lower_bounded!(isize => u16, u24, u32, u64, u128);
    impl_try_from_both_bounded!(isize => i8);
    impl_try_from_unbounded!(isize => i16, i24, i32, i64, i128);

    rev!(impl_try_from_upper_bounded, usize => u24, u32, u64, u128);
    rev!(impl_try_from_lower_bounded, usize => i8, i16);
    rev!(impl_try_from_both_bounded, usize => i24, i32, i64, i128);

    rev!(impl_try_from_upper_bounded, isize => u16, u24, u32, u64, u128);
    rev!(impl_try_from_both_bounded, isize => i24, i32, i64, i128);
}
...
mod ptr_try_from_impls {
    ...
    impl_try_from_unbounded!(usize => u24, u32, u64, u128);
    impl_try_from_upper_bounded!(usize => i8, i16, i24);
    impl_try_from_unbounded!(usize => i32, i64, i128);

    impl_try_from_both_bounded!(isize => u8, u16);
    impl_try_from_lower_bounded!(isize => u24, u32, u64, u128);
    impl_try_from_both_bounded!(isize => i8, i16);
    impl_try_from_unbounded!(isize => i24, i32, i64, i128);

    rev!(impl_try_from_upper_bounded, usize => u32, u64, u128);
    rev!(impl_try_from_lower_bounded, usize => i8, i16, i24);
    rev!(impl_try_from_unbounded, usize => u24);
    rev!(impl_try_from_both_bounded, usize => i32, i64, i128);

    rev!(impl_try_from_unbounded, isize => u16);
    rev!(impl_try_from_upper_bounded, isize => u24, u32, u64, u128);
    rev!(impl_try_from_unbounded, isize => i24);
...
mod ptr_try_from_impls {
    ...
    impl_try_from_upper_bounded!(usize => u8, u16, u24);
    impl_try_from_unbounded!(usize => u32, u64, u128);
    impl_try_from_upper_bounded!(usize => i8, i16, i24, i32);
    impl_try_from_unbounded!(usize => i64, i128);

    impl_try_from_both_bounded!(isize => u8, u16, u24);
    impl_try_from_lower_bounded!(isize => u32, u64, u128);
    impl_try_from_both_bounded!(isize => i8, i16, i24);
    ...
    rev!(impl_try_from_lower_bounded, usize => i8, i16, i24, i32);
    rev!(impl_try_from_both_bounded, usize => i64, i128);

    rev!(impl_try_from_unbounded, isize => u16, u24);
...
impl_nonzero_int_from_nonzero_int!(u8 => u24);
...
impl_nonzero_int_from_nonzero_int!(u16 => u24);
...
impl_nonzero_int_from_nonzero_int!(i8 => i24);
...
impl_nonzero_int_from_nonzero_int!(i16 => i24);
...
impl_nonzero_int_from_nonzero_int!(u8 => i24);
...
impl_nonzero_int_from_nonzero_int!(u16 => i24);
...
impl_nonzero_int_try_from_int!(u24);
...
impl_nonzero_int_try_from_nonzero_int!(u24 => u8, u16, usize);
impl_nonzero_int_try_from_nonzero_int!(u32 => u8, u16, u24, usize);
impl_nonzero_int_try_from_nonzero_int!(u64 => u8, u16, u24, u32, usize);
impl_nonzero_int_try_from_nonzero_int!(u128 => u8, u16, u24, u32, u64, usize);
impl_nonzero_int_try_from_nonzero_int!(usize => u8, u16, u24, u32, u64, u128);

// signed non-zero integer -> signed non-zero integer
impl_nonzero_int_try_from_nonzero_int!(i16 => i8);
impl_nonzero_int_try_from_nonzero_int!(i24 => i8, i16, isize);
impl_nonzero_int_try_from_nonzero_int!(i32 => i8, i16, i24, isize);
impl_nonzero_int_try_from_nonzero_int!(i64 => i8, i16, i24, i32, isize);
impl_nonzero_int_try_from_nonzero_int!(i128 => i8, i16, i24, i32, i64, isize);
impl_nonzero_int_try_from_nonzero_int!(isize => i8, i16, i24, i32, i64, i128);
...
impl_nonzero_int_try_from_nonzero_int!(u24 => i8, i16, i24, isize);
impl_nonzero_int_try_from_nonzero_int!(u32 => i8, i16, i24, i32, isize);
impl_nonzero_int_try_from_nonzero_int!(u64 => i8, i16, i24, i32, i64, isize);
impl_nonzero_int_try_from_nonzero_int!(u128 => i8, i16, i24, i32, i64, i128, isize);
impl_nonzero_int_try_from_nonzero_int!(usize => i8, i16, i24, i32, i64, i128, isize);

// signed non-zero integer -> unsigned non-zero integer
impl_nonzero_int_try_from_nonzero_int!(i8 => u8, u16, u24, u32, u64, u128, usize);
impl_nonzero_int_try_from_nonzero_int!(i16 => u8, u16, u24, u32, u64, u128, usize);
impl_nonzero_int_try_from_nonzero_int!(i24 => u8, u16, u24, u32, u64, u128, usize);
impl_nonzero_int_try_from_nonzero_int!(i32 => u8, u16, u24, u32, u64, u128, usize);
impl_nonzero_int_try_from_nonzero_int!(i64 => u8, u16, u24, u32, u64, u128, usize);
impl_nonzero_int_try_from_nonzero_int!(i128 => u8, u16, u24, u32, u64, u128, usize);
impl_nonzero_int_try_from_nonzero_int!(isize => u8, u16, u24, u32, u64, u128, usize);
