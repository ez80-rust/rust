...
spec_int_ranges!(u8 u16 u24 u32 u64 usize);
// DoubleEndedIterator requires ExactSizeIterator, which isn't implemented for Range<u64>
#[cfg(target_pointer_width = "64")]
spec_int_ranges_r!(u8 u16 u24 u32 usize);

#[cfg(target_pointer_width = "32")]
spec_int_ranges!(u8 u16 u24 u32 usize);
#[cfg(target_pointer_width = "32")]
spec_int_ranges_r!(u8 u16 u24 u32 usize);
...
spec_int_ranges!(u8 u16 u24 usize);
#[cfg(target_pointer_width = "24")]
spec_int_ranges_r!(u8 u16 u24 usize);
